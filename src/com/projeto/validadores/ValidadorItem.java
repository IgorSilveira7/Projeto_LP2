...
public class ValidadorItem {
	 ...
	 * 
	 * @param nome
	 *            do tipo String, referente a o nome do item.
	 * @param categoria
	 *            do tipo String, referente a categoria do item.
	 * @param supermercado
	 *            do tipo String, referente ao supermercado onde o item esta
	 *            localizado.
	 * @param preco
	 *            do tipo Double, referente ao preco do item.
	 * @return Boolean True e lanca a excecao se algum erro no cadastro for
	 *         localizado.
	 */
	...
	/**
	 * Metodo com retorno booleano na validacao de um item que ja existe na lista
	 * (por quantidade).
	 * 
	 * @param itens
	 *            referente ao mapa entre inteiro e nome do item.
	 * @param nome
	 *            do tipo String, referente ao nome do item.
	 * @param categoria
	 *            do tipo String, referente a categoria do item.
	 * @return Boolean true, mas lanca a excecao se o item ja estiver cadastrado na
	 *         lista.
	 */
	...
	/**
	 * Metodo com retorno booleano na validacao de um item ja existente (por
	 * unidade).
	 * 
	 * @param itens
	 *            referente ao mapa entre inteiro e nome do item.
	 ...
	 * @param categoria
	 *            do tipo String, referente a categoria do item.
	 * @return Boolean true, e lanca a excecao caso o item ja esteja cadastrado na
	 *         lista.
	 */
	...
	/**
	 * Metodo com retorno booleano na validacao de um item ja existente (nao
	 * industrializado).
	 * 
	 * @param itens
	 *            referente ao mapa entre inteiro e nome do item.
	 ...
	 * 
	 * @param novo
	 *            do tipo String, referente ao novo nome do item, a ser atualizado.
	 * @return Boolean true, e lanca a excecao caso haja erro na atualizacao do nome
	 *         do item.
	 */
	 ...
	 * 
	 * @param localDeCompra
	 *            do tipo String, referente ao local de compra do produto.
	 * @param preco
	 *            do tipo Double, referente ao preco de um item.
	 * @return Boolean true, e lanca excecao caso o nome do local de compra seja
	 *         vazio ou nulo ou se o preco do item for invalido.
	 */
	 ...
	 * 
	 * @param categoria
	 *            do tipo String, referente a categoria de determinado produto.
	 * @return Boolean true, lanca a excecao caso haja erro na categoria do item,
	 ...
	 * 
	 * @param novoValor
	 *            do tipo String, referente a nova categoria do item.
	 * @return Boolean true, lanca a excecao caso a categoria a ser alterada nao
	 *         exista.
	 */
	 ...
	 * 
	 * @param unidade
	 *            do tipo Inteiro, referente a unidade do item.
	 * @return Boolean true, lanca a excecao caso unidade seja um valor menor que 0
	 *         por ser invalido.
	 */
	 ...
	 * @param unidade
	 *            do tipo Inteiro, referente a unidade do item.
	 * @return Boolean true, e lanca excecao caso a alteracao se der em um valor
	 *         unitario menor que 0.
	 */
	 ...
	 * 
	 * @param peso
	 *            do tipo Double, referente ao peso de determinado produto.
	 * @return Boolean true, lanca excecao caso o valor em quilos do produto seja
	 *         menor que 0.
	 */
	 ...
	 * 
	 * @param quantidade
	 *            do tipo Inteiro, referente a quantidade de determinado produto.
	 * @param medida
	 *            do tipo String, referente a unidade de medida referente a um item.
	 * @return Boolean true, lanca excecao caso a quantidade ou a unidade de medida
	 *         sejam vazias ou nulas.
	 */
	 ...
	 * 
	 * @param quantidade
	 *            do tipo Inteiro, referente a nova quantidade do item.
	 ...
	 * 
	 * @param medida
	 *            do tipo String, referente a unidade de medida do produto
	 *            determinado.
	 * @return Boolean true, caso a medida seja vazia ou nula retorna tambem uma
	 *         excecao.
	 */
	 ...
	 * 
	 * @param novoValor
	 *            do tipo Double, referente ao novo valor em quilos do item.
	 * @return Boolean true, mas, caso o valor em quilos seja menor que 0 lanca uma
	 *         excecao.
	 */
